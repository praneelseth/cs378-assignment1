...
#### **Released:** Thursday, September 10, 2026, 12:00 AM CT <br/> **Due:** Monday, September 21, 2026, 11:59 PM CT
...
This assignment is to be completed with your **registered group**.
...
1. **Get the skeleton code.** Create a **private** repository from this
   template (`Use this template > Create a new repository`, select `Private`).
...
We follow the [FlashAttention](https://arxiv.org/abs/2205.14135) paper's
notation (`Br`, `Bc`, `l`, `m`).
...
Submission is to be done through **Canvas**. Only one person per group is
required to submit.
...
and on the UT CS 378 flash-attention assignment. We thank those authors for
making their materials publicly available.
